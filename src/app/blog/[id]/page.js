...
export default async function Slug({ params }) {
  ...
  return (
    <div className="flex container mx-auto">
      {data.image_url && (
        <div className="border-4 border-yellow-200 m-5 rounded-lg mb-auto mr-30 object-contain">
          <Image
            src={data.image_url}
            width={300}
            height={200}
      ...
      <div className="flex container mx-auto  flex-col items-center pt-6">
        ...
        <div className="border-4 border-yellow-200 p-5 rounded-lg mb-4 w-full max-w-3xl">
          <div className=" flex container mx-auto text-center  pl-20  ml-20 mt-5  font-serif font-bold  mb-auto text-gray-200">
            {" "}
          </div>
